		...
		<div id="tabs">
			...
			<div id="tabs-1">
				...
				<fieldset class="fieldset white">
					...
					<p>
						<label class="title"><?php __('lblListingConfirmTokens'); ?></label>
						<textarea name="value-text-o_email_new_reservation" class="pj-form-field w500 h400"><?php echo stripslashes($tpl['o_arr']['o_email_new_reservation']); ?></textarea>
					</p>
					<p>
						<label class="title">&nbsp;</label>
						<input type="submit" value="<?php __('btnSave'); ?>" class="pj-button" />
				...
				<fieldset class="fieldset white">
					<legend><?php __('opt_o_email_welcome_msg'); ?></legend>
					<p>
						<label class="title"><?php __('opt_subject'); ?></label>
						<input type="text" name="value-string-o_email_welcome_msg_subject" class="pj-form-field w500" value="<?php echo htmlspecialchars(stripslashes($tpl['o_arr']['o_email_welcome_msg_subject'])); ?>" />
					</p>
					<p>
						<label class="title"><?php __('opt_body_welcome_msg'); ?></label>
						<textarea name="value-text-o_email_welcome_msg" class="pj-form-field w500 h150"><?php echo stripslashes($tpl['o_arr']['o_email_welcome_msg']); ?></textarea>
					</p>
					<p>
						<label class="title">&nbsp;</label>
						<input type="submit" value="<?php __('btnSave'); ?>" class="pj-button" />
