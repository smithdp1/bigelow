...
<?php include_once PJ_VIEWS_PATH . 'pjListings/elements/urlLanguage.php'; ?>
<form action="?controller=pjListings&amp;action=pjActionView<?php echo $QS_LANG; ?>&amp;id=<?php echo $tpl['listing_id']; ?>" method="post" id="frmPLBooking" name="frmPLBooking" class="property-form property-view-form">
	...
	<p class="selector-err" style="display:none"></p>
	...
	<p>
		...
		<img class="property-captcha" src="<?php echo PJ_INSTALL_FOLDER; ?>index.php?controller=pjFront&amp;action=pjActionCaptcha&amp;rand=<?php echo rand(1, 999999); ?>" alt="CAPTCHA" style="vertical-align: middle" />
