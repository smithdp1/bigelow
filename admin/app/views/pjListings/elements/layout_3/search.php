...
<div class="property-container">
	...
	<div class="property-state">
		...
		<form action="<?php echo $listingPage; ?>" method="get" class="property-form property-search-form" id="vrSearchForm">
			...
			<div class="vrl-float-left vrl-w45p vrl-l20">
				...
				<p>
					<label class="property-title"><?php __('front_search_city'); ?>:</label>
					<span id="vrlCityBox"><?php $_GET['cityClass'] = 'property-select vrl-w180'; include PJ_VIEWS_PATH . 'pjListings/pjActionGetCities.php'; ?></span>
				</p>
				<p>
