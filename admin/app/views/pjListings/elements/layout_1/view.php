	...
	if (!empty($tpl['arr']['listing_description']))
	{
		...
		<div class="property-state vrl-t10">
			<div class="property-view-content">
				...
				<div class="vrl-lh20 property-state-rte"><?php echo stripslashes(pjUtil::stripScripts($tpl['arr']['listing_description'])); ?></div>
			</div>
		</div>
		<?php
	}
