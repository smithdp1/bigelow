		...
		if ($tpl['arr']['contact_show'] == 1)
		{
			...
			<div class="property-state">
				...
				if (!empty($tpl['arr']['personal_title']) or !empty($tpl['arr']['personal_fname']) or !empty($tpl['arr']['personal_lname']))
				{
					...
					?><p class="vrl-overflow"><span class="vrl-float-left vrl-w35p"><?php __('front_view_name'); ?></span><span class="vrl-float-left vrl-w64p vrl-bold vrl-color-black"><?php echo htmlspecialchars(stripslashes(@$pt[$tpl['arr']['personal_title']] . " " .$tpl['arr']['personal_fname'] . " " . $tpl['arr']['personal_lname'])); ?></span></p><?php
				}
