...
$pjDrawSearch = pjObject::getPlugin('pjDrawSearch') !== NULL;
?>
<div class="property-container">
	...
	<div class="property-pattern">
		...
		<form action="<?php echo $listingPage; ?>" method="get" class="property-search-form" id="vrSearchForm">
			...
			<div class="vrl-float-left vrl-w25p">
				...
				<p>
					<label class="property-form-label"><?php __('front_search_city'); ?>:</label>
					<span id="vrlCityBox"><?php $_GET['cityClass'] = 'property-select vrl-w160'; include PJ_VIEWS_PATH . 'pjListings/pjActionGetCities.php'; ?></span>
				</p>
				<p>
			...
			<br class="vrl-clear-left" />
			<?php
			if ($pjDrawSearch)
			{
				include PJ_VIEWS_PATH . 'pjListings/elements/viewDrawSearch.php';
			} else {
				?>
				<p>
