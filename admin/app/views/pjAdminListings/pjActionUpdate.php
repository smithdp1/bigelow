			...
			<div id="tabs-9" style="padding: 10px 0">
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<span class="block t5">
							<input name="i18n[<?php echo $v['id']; ?>][confirm_subject]" class="pj-form-field w500 b10" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['confirm_subject'])); ?>" placeholder="<?php __('lblListingTermsSubject'); ?>" />
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
						</span>
						<span class="block t5">
				...
				foreach ($tpl['lp_arr'] as $v)
				{
					...
					<div class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
						...
						<span class="block t5">
							<input name="i18n[<?php echo $v['id']; ?>][payment_subject]" class="pj-form-field w500 b10" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['payment_subject'])); ?>" placeholder="<?php __('lblListingTermsSubject'); ?>" />
							<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
						</span>
						<span class="block t5">
