<div id="tabs-8">
	...
	<table cellpadding="0" cellspacing="0" class="pj-table" style="width: 100%">
		...
		<tr class="AuthorizeNet" style="<?php echo @$tpl['arr']['o_allow_authorize'] != 1 ? 'display: none' : NULL; ?>">
			<td><span class="block bold"><?php __('lblListingAuthorizeHash'); ?></span><span class="fs10"><?php __('lblListingAuthorizeHashText'); ?> </span></td>
			<td class="tblError"><span><input type="text" id="o_authorize_hash" name="o_authorize_hash" value="<?php echo str_replace('"','&quot;',stripslashes(utf8_decode(@$tpl['arr']["o_authorize_hash"]))); ?>" class="pj-form-field w150<?php echo @$tpl['arr']['o_allow_authorize'] == 1 ? ' required' : '';?>" /></span></td>
		</tr>
		<tr class="AuthorizeNet" style="<?php echo @$tpl['arr']['o_allow_authorize'] != 1 ? 'display: none' : NULL; ?>">
