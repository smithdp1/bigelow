...
class pjAppController extends pjController
{
    ...
    public static function getTokens($booking_arr, $listing_arr, $option_arr)
    {
    	$search = array(
		...
		$replace = array(
			...
			@$booking_arr['payment_method'], @$booking_arr['listing_id'], @$listing_arr['listing_refid'],
			@$booking_arr['date_from'], @$booking_arr['date_to'], @$booking_arr['id'], @$booking_arr['uuid'],
	...
	public function notify($notification_id, $user_id=NULL, $params=array())
	{
		...
		$tokens = pjAppController::getTokens($params, $params, $this->option_arr);
